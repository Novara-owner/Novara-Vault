...
- **弹窗小窗友好** —— 全应用弹窗适配分屏与矮窗口：确认键恒定在卡片底部可见、长内容滚动而非被裁切、窗口拖动时已打开的弹窗实时重排
- **便签整页滚动编辑** —— 便签弹窗标题与确认键固定，内容区整页滚动，任意窗口尺寸下长便签都能顺畅编辑
- **可预期的置顶** —— 备忘条目置顶只升到自己分组或未分类栈的顶部、绝不越区；分组置顶携组内全部条目升至列表最上方。条目跨组移动后不带旧标记——星标与置顶留在原地
